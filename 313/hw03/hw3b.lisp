...
;;; func: id
;;; params:
;;;	course:		course numner
;;;	assgment:	assignment number
(defun id (course assigment)
"Print name, course, and assignment"
	(format t "Name: ~A~%Course: ~A~%Assignment # ~A" +ID+ course assigment)
)
...
(defparameter *nodes*
	'(
		...
		(bedroom
			(you are in the bedroom. there is a necklace in the corner)
		)
	)
)
...
(defparameter *objects* '(whiskey bucket frog chain necklace))
