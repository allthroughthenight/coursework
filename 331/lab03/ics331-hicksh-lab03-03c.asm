...
addi $a0 $0 7 # seed
addi $a1 $0 20 # max number

addi $v0 $0 42 # load syscall
syscall
addi $t6 $a0 0 # store value for later

lw $a0, ($sp) # restore $a0
lw $a1, 4($sp) # restore $a0
...
addi $a0 $0 0 # seed
addi $a1 $0 0x00FFFFFF # max number
